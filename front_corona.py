...
import numpy as np
import datetime
from get_data import read_regions_list, read_data, read_regions_data
...
#data_folder = 'data/'
#regions_path = data_folder + 'regions.txt'

#regions_dict =  read_regions_list(regions_path)
...
regions_list = regions_data.columns[1:]
